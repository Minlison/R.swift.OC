...
public enum Module: ExpressibleByStringLiteral, CustomStringConvertible, Hashable {
    ...
    public var hashValue: Int {
        ...
        case .uikit: return "--UIKit".hashValue
        case .foundation : return "--Foundation".hashValue
    ...
    public var description: String {
        switch self {
        case .host: return "UIKit"
        case .stdLib: return "UIKit"
    ...
    public init(name: String?, fallback: Module = .uikit) {
        switch name {
